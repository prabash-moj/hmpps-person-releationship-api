...
--
alter sequence if exists contact_contact_id_seq restart with 29;
alter sequence if exists contact_address_contact_address_id_seq restart with 13;
...
alter sequence if exists reference_codes_reference_code_id_seq restart with 38;
alter sequence if exists prisoner_contact_prisoner_contact_id_seq restart with 29;
